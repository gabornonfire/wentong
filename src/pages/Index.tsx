  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-[760px] mx-auto px-6 pb-32">
        {/* Foreword */}
        <RevealOnScroll>
          <div className="bg-card-elevated border border-border border-l-2 border-l-accent/25 rounded-lg p-[22px] px-[26px] mt-[52px]">
        ...
        <RevealOnScroll>
          <div className="flex gap-2 flex-wrap mb-7">
            {[
              { label: "🌡 FIR termoterápia", cls: "text-primary border-primary/30 bg-primary-dim" },
              ...
              { label: "🦶 Reflexterápia", cls: "text-accent border-accent/25 bg-accent-dim" },
            ].map((pill) => (
              <span
                key={pill.label}
        ...
        <RevealOnScroll>
          ...
          >
            <p>
              Az infravörös sugárzás az elektromágneses spektrum látható fény alatti tartománya, amelyet az emberi bőr hőként érzékel, de amely nem korlátozódik a bőr felszínére. A <strong>Far-Infrared (FIR)</strong> tartomány (4–14 µm) különösen fontos a biológiai rendszerek szempontjából, mert pontosan egybeesik azzal a hullámhossz-tartománnyal, amelyet a vízzel teli biológiai szövetek a leghatékonyabban abszorbeálnak.
            </p>
            <p>
              <strong>Miért hatol be a szövetbe?</strong> A bőr, az izomszövet és a kötőszövet felépítése megengedi, hogy a sugárzás több centiméteres mélységbe hatoljon, ahol közvetlen termikus és nem-termikus biofizikai hatást fejt ki. A FIR tartomány 1–3 cm mélységig hat közvetlen hőhatással, de a másodlagos értágulatból eredő keringésfokozás ennél jóval mélyebb szöveteket érint.
            </p>
            <p>
              <strong>Mitokondriális aktiváció:</strong> A közeli és közepes infravörös fény kölcsönhat a sejtek mitokondriális légzési láncával — különösen a citokróm-c-oxidáz (CcO) enzimmel. Ez fokozott ATP-termelést, oxidatív stressz csökkentést és sejt-szintű regenerációs jelpályák beindítását eredményezi.
            </p>
            <p>
              <strong>Mikrokeringési hatás:</strong> A FIR sugárzás fokozza a nitrogén-monoxid (NO) felszabadulását az endotél sejtekből. A NO a legerősebb ismert endogén értágító — hatására az artériák és kapillárisok ellazulnak, az áramlási sebesség nő, a szövetoxigenizáció javul. Ezt a mechanizmust randomizált kontrollos vizsgálatok igazolták.
            </p>
          </TechBlock>
        </RevealOnScroll>
        ...
        <RevealOnScroll>
          ...
          >
            <p>
              A fotobiomoduláció (PBM) az a biofizikai jelenség, amelynek során meghatározott hullámhosszú, alacsony intenzitású fény biológiai hatást vált ki hőtermelés nélkül. <strong>Nem hőhatásról van szó</strong>, hanem fény által indukált kémiai reakciókról a sejtekben.
            </p>
            <p>
              <strong>Vörös fény (630–660 nm) — a regeneráció tartománya:</strong> A vörös fény a mitokondriális légzéslánc citokróm-c-oxidáz enzimének egyik fő abszorpciós csúcsában esik. Az enzim felszívja a fotonokat, felgyorsul az elektrontranszport lánc. Az eredmény: fokozott ATP-szintézis, csökkent reaktív oxigéngyök (ROS) szint, és pro-regeneratív jelpályák aktiválódása.
            </p>
            <p>
              A Journal of Photochemistry and Photobiology áttekintéseiben dokumentált, hogy a 630–670 nm-es vörös fény gyorsítja a sebgyógyulást, csökkenti az izomfáradás markerereit (kreatin-kináz), és mérsékli a gyulladásos citokinek szintjét sportolókban.
            </p>
            <p>
              <strong>Kék fény (415 nm) — az antimikrobiális tartomány:</strong> A 400–430 nm tartomány aktiválja a porfirin kromofórokat a baktériumok sejtmembránjában — különösen az S. aureus esetén. Az aktivált porfirinek reaktív oxigéngyököket termelnek, amelyek a baktérium sejtfalát és DNS-ét károsítják. Antibiotikum-rezisztens törzsekre is hatékony lehet.
            </p>
          </TechBlock>
        </RevealOnScroll>
        ...
        <RevealOnScroll>
          ...
          >
            <p>
              A levegő ionjai elektromos töltéssel rendelkező légköri részecskék. A természetben negatív ionok keletkeznek vízesések közelében, erdőkben fenyők illó anyagainak hatására, és elektromos kisülések során. A városokban, zárt terekben ezzel szemben negatív ion hiány és pozitív ion túlsúly jellemző.
            </p>
            <p>
              <strong>Hogyan hat a levegő ionizálása?</strong> A negatív ionok elektrosztatikusan kötik meg a levegőben lebegő részecskéket (por, pollenek, aerosolok, baktériumok). Az összetapadt, negatívan töltött klaszterek leülepednek — ezzel csökkentik a légúti expozíciót.
            </p>
            <p>
              <strong>Mikrobicid hatás:</strong> A Comini és munkatársai (2021, Microbiology Spectrum) vizsgálatában negatív ion generátor ~95%-kal csökkentette az S. aureus, és ~70%-kal az E. coli légköri koncentrációját zárt térben. A mechanizmus: az ionok reaktív oxigén intermediereket indukálnak a baktérium sejtfalán.
            </p>
            <p>
              <strong>Légzőszervi és hangulati hatások:</strong> Több vizsgálat pozitív tendenciákat talált a légúti tünetekre és szubjektívan javuló légzésminőségre. Néhány vizsgálat összefüggést talált a magas negatív ion koncentráció és a szerotonin metabolizmus között — ezek az adatok azonban előzetesek.
            </p>
          </TechBlock>
        </RevealOnScroll>

        {/* Contra box for ION - placed after ION block */}
        <RevealOnScroll>
        ...
        <RevealOnScroll>
          ...
          >
            <p>
              A talp az emberi test egyik legsűrűbben innervált felülete. Négyzetcentimétere körülbelül <strong>7200 idegvégződést</strong> tartalmaz — köztük mechanoceptorokat, proprioceptorokat és szabad idegvégződéseket. Ez az idegi sűrűség magyarázza, miért vált ki talpmasszázs azonnali, az egész testen érzékelhető választ.
            </p>
            <p>
              <strong>Keringési hatás a lábfejben:</strong> Ko és Lee (2018, Journal of Physiological Anthropology, PMC) igazolta, hogy a lábfej termikus stimulálása szignifikánsan javítja a periférián mért véráramlást és lerövidíti az elalvási latenciát — a test termális szabályozásán keresztül.
            </p>
            <p>
              <strong>A kombinált stimuláció szinergizmusa:</strong> A Wentong 1.0 esetén a FIR hőterápia, fotobiomoduláció és ionizáció kombinálódik a talpstimulációval. A hőterápia értágít és ellazít, a fény mitokondriálisan aktivál, az ionok felszínileg hatnak, míg a reflexzónák stimulálása szisztémás idegi válaszokat indít be.
            </p>
          </TechBlock>
        </RevealOnScroll>
